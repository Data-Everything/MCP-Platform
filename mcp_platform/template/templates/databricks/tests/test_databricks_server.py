...
class TestDatabricksMCPServer:
    ...
    def test_server_initialization(self, mock_workspace_client_class, server_config, mock_workspace_client):
        ...
        assert server.config_data["workspace_host"] == "https://dbc-12345.cloud.databricks.com"
    ...
    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    def test_authentication_methods(self, mock_workspace_client_class, mock_workspace_client):
    ...
    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    @pytest.mark.asyncio
    async def test_list_clusters(self, mock_workspace_client_class, server_config, mock_workspace_client):
    ...
    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    @pytest.mark.asyncio
    async def test_list_warehouses(self, mock_workspace_client_class, server_config, mock_workspace_client):
    ...
    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    @pytest.mark.asyncio
    async def test_list_databases(self, mock_workspace_client_class, server_config, mock_workspace_client):
    ...
    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    @pytest.mark.asyncio
    async def test_list_tables(self, mock_workspace_client_class, server_config, mock_workspace_client):
    ...
    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    @pytest.mark.asyncio
    async def test_describe_table(self, mock_workspace_client_class, server_config, mock_workspace_client):
        """Test describing table functionality."""
        mock_workspace_client_class.return_value = mock_workspace_client
        
        server = DatabricksMCPServer(config_dict=server_config)
        result = await server.describe_table(database="main.default", table="test_table")
    ...
    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    @pytest.mark.asyncio
    async def test_execute_query_read_only_mode(self, mock_workspace_client_class, server_config, mock_workspace_client):
        ...
        result = await server.execute_query(query="SELECT * FROM main.default.test_table LIMIT 10")
        ...
        result = await server.execute_query(query="INSERT INTO main.default.test_table VALUES (1, 'test')")
        assert "error" in result
        assert "read-only mode" in result["error"]

    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    @pytest.mark.asyncio
    async def test_execute_query_write_mode(self, mock_workspace_client_class, mock_workspace_client):
    ...
    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    @pytest.mark.asyncio
    async def test_get_cluster_info(self, mock_workspace_client_class, server_config, mock_workspace_client):
    ...
    @patch('mcp_platform.template.templates.databricks.server.WorkspaceClient')
    @pytest.mark.asyncio
    async def test_get_warehouse_info(self, mock_workspace_client_class, server_config, mock_workspace_client):
